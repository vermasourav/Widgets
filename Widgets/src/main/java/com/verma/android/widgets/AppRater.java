 ...
 * Class name : AppRater
 * Last modified:  11/03/24, 11:45 pm
...
public class AppRater {
    ...
    private static final AppRater ourInstance = new AppRater();
    ...
    public void setAppTitle(String pName) {
        APP_TITLE = pName;
    }
    ...
    public void app_launched(Context mContext) {
        SharedPreferences prefs = mContext.getSharedPreferences("Widged", 0);
