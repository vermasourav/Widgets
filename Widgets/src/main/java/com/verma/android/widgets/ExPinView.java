 ...
 * Class name : ExPinView
 * Last modified:  14/03/24, 10:30 pm
 * Location: Bangalore, India
 */

package com.verma.android.widgets;
...
import com.verma.android.widgets.expin.DefaultMovementMethod;
 ...
 * 01/04/2017
 */
public class ExPinView extends AppCompatEditText {

    private static final String TAG = "ExPinView";
    ...
    public ExPinView(Context context) {
        this(context, null);
    }

    public ExPinView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.exPinViewStyle);
    }

    public ExPinView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.ExPinView, defStyleAttr, 0);

        mViewType = a.getInt(R.styleable.ExPinView_viewType, VIEW_TYPE_RECTANGLE);
        mPinItemCount = a.getInt(R.styleable.ExPinView_itemCount, DEFAULT_COUNT);
        mPinItemHeight = (int) a.getDimension(R.styleable.ExPinView_itemHeight, res.getDimensionPixelSize(R.dimen.ex_pv_pin_view_item_size));
        mPinItemWidth = (int) a.getDimension(R.styleable.ExPinView_itemWidth, res.getDimensionPixelSize(R.dimen.ex_pv_pin_view_item_size));

        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.ExPinView_itemSpacing, res.getDimensionPixelSize(R.dimen.ex_pv_pin_view_item_spacing));
        mPinItemRadius = (int) a.getDimension(R.styleable.ExPinView_itemRadius, 0);
        mLineWidth = (int) a.getDimension(R.styleable.ExPinView_lineWidth, res.getDimensionPixelSize(R.dimen.ex_pv_pin_view_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.ExPinView_lineColor);
        isCursorVisible = a.getBoolean(R.styleable.ExPinView_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.ExPinView_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.ExPinView_cursorWidth,
                res.getDimensionPixelSize(R.dimen.ex_pv_pin_view_cursor_width));

        mItemBackground = a.getDrawable(R.styleable.ExPinView_android_itemBackground);
        mHideLineWhenFilled = a.getBoolean(R.styleable.ExPinView_hideLineWhenFilled, false);
